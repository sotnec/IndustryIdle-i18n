export const TR = {
    ...
    Settings: "Ayarlar",
    Sound: "Ses Efekti",
    SoundDesc: "Tıklama ve hata sesi ses efektlerini açar",
    ...
    OrderFilled: "%{from} tarafından verilen sipariş başarıyla tamamlandı!",
    PolicyCenter: "Politika Merkezi",
    NewOrder: "%{from} firmasından yeni bir sipariş geldi, lütfen Toptan Satış Merkezini kontrol edin",
    Policies: "Politikalar",
    PolicyNotEnoughTime: "Bu politika için yeterli politika puanınız yok",
    WholesaleCenterOrderFasterDesc: "Toptan Satış Merkezi siparişleri 2 kat daha hızlı alır ve sipariş boyutu 2 kat daha büyüktür",
    ...
    Chat: "Sohbet",
    RestoreFromBackup: "Yedeği geri yükle",
    RestoreFromBackupFail: "Steam Cloud yedeği geri yüklenemedi: Bir yedekleme olduğundan emin misin?",
    RestoreFromBackupTitle: "Emin misin?",
    RestoreFromBackupDesc:
        "Yerel kaydetmeniz kaybolmadıkça, normalde bulut yedeklemesinden geri yüklemeniz gerekmez. Bulut yedekleme, yerel kaydetmenizden biraz daha eski",
    ...
    ChatMessageRateLimit: "Her 10 saniyede bir yeni bir sohbet mesajı gönderebilirsin",
